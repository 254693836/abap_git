...
define view entity ZLYZ110_C_BOOKINGTP_SOL
  as projection on ZLYZ110_R_BOOKINGTP_SOL
{
  ...
  key     BookingID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZLYZ110_CALC_BOOK_ELEM_SOL'
  ...
  virtual DaysToFlightIndicator  : abap.int1,
          ...
          // public associations
          _Travel : redirected to parent ZLYZ110_C_TRAVELTP_SOL,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
