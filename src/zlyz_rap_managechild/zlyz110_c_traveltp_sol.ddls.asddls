...
define root view entity ZLYZ110_C_TRAVELTP_SOL
  provider contract transactional_query
  as projection on ZLYZ110_R_TRAVELTP_SOL
{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZLYZ110_CALC_TRAV_ELEM_SOL'
  ...
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZLYZ110_C_BOOKINGTP_SOL,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
