CLASS zlyz110_calc_trav_elem_sol DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_trav_status_ind
        IMPORTING is_original_data TYPE ZLYZ110_C_TravelTP_SOL
        RETURNING VALUE(result)    TYPE ZLYZ110_C_TravelTP_SOL.
...
CLASS zlyz110_calc_trav_elem_sol IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'OVERALLSTATUSINDICATOR'.
          ...
          DATA lt_trav_original_data TYPE STANDARD TABLE OF ZLYZ110_C_TravelTP_SOL WITH DEFAULT KEY.
          ...
          LOOP AT lt_trav_original_data ASSIGNING FIELD-SYMBOL(<fs_trav_original_data>).
            ...
            <fs_trav_original_data> = ZLYZ110_calc_trav_elem_SOL=>calculate_trav_status_ind( <fs_trav_original_data> ).
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZLYZ110_C_TRAVELTP_SOL'. "Travel BO node
