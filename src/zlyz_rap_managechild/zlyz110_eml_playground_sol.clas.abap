CLASS zlyz110_eml_playground_sol DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zlyz110_eml_playground_sol IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    "declare internal table using derived type
    DATA travel_keys TYPE TABLE FOR READ IMPORT ZLYZ110_R_TravelTP_SOL .
    ...
    READ ENTITIES OF ZLYZ110_R_TravelTP_SOL
      ENTITY Travel
*        ALL FIELDS
