CLASS zcl_lyz100_gen_data_sol DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_lyz100_gen_data_sol IMPLEMENTATION.
...
*   clear data
    DELETE FROM zlyz100_atravsol.
*    DELETE FROM zlyz100_dtravsol.

    "insert travel demo data
    INSERT zlyz100_atravsol  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[LYZ100] Demo data generated for table ZLYZ100_ATRAV{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
