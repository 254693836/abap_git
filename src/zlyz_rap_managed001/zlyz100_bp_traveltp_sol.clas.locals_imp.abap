...
CLASS LHC_TRAVEL IMPLEMENTATION.
  ...
  DATA:
  entity           TYPE STRUCTURE FOR CREATE ZLYZ100_R_TravelTP_sol,
...
ELSE.
  ...
  SELECT SINGLE FROM zlyz100_atravsol FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
  "Get max travel ID from draft table
  SELECT SINGLE FROM zlyz100_dtravsol FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
...
READ ENTITIES OF ZLYZ100_R_TravelTP_sol IN LOCAL MODE
 ENTITY Travel
...
MODIFY ENTITIES OF ZLYZ100_R_TravelTP_sol IN LOCAL MODE
  ENTITY Travel
    UPDATE SET FIELDS
...
METHOD deductDiscount.
  DATA travels_for_update TYPE TABLE FOR UPDATE ZLYZ100_R_TravelTP_sol.
...
METHOD copyTravel.
   DATA:
      travels       TYPE TABLE FOR CREATE zlyz100_r_traveltp_sol\\travel.
