CLASS zlyz100_cl_eml_SOL DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zlyz100_cl_eml_SOL IMPLEMENTATION.
...
*    COMMIT ENTITIES
*      RESPONSE OF ZLYZ100_R_TravelTP_SOL
