"! @testing BDEF:ZLYZ100_R_TravelTP_sol
CLASS zlyz100_tc_travel_eml_sol DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zlyz100_tc_travel_eml_sol IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZLYZ100_R_TravelTP_sol' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF ZLYZ100_R_TravelTP_sol
     ENTITY Travel
    ...
    SELECT * FROM ZLYZ100_R_TravelTP_sol INTO TABLE @DATA(lt_travel). "#EC CI_NOORDER
