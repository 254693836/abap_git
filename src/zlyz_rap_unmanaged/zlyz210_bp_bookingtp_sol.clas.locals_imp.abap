...
**************************************************************************
  METHOD getDaysToFlight.
    DATA:
      c_booking_entity TYPE ZLYZ210_C_BookingTP_SOL,
      bookings_result  TYPE TABLE FOR FUNCTION RESULT zlyz210_r_traveltp_SOL\\booking~getdaystoflight,
...
*         ALL FIELDS
    ...
    LOOP AT bookings ASSIGNING FIELD-SYMBOL(<booking>).
      ...
      booking_result-%param
        = CORRESPONDING #( zlyz210_calc_book_elem_SOL=>calculate_days_to_flight( c_booking_entity )
...
**************************************************************************
  METHOD setInitialBookingValues.
    ...
    DATA: update TYPE TABLE FOR UPDATE zlyz210_r_traveltp_SOL\\Booking.
