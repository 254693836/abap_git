...
define view entity ZLYZ210_C_BOOKINGTP_SOL
  as projection on ZLYZ210_R_BOOKINGTP_SOL
{
  ...
  key     BookingID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZLYZ210_CALC_BOOK_ELEM_SOL'
  ...
  virtual DaysToFlightIndicator  : abap.int1,
          ...
          // public associations
          _Travel : redirected to parent ZLYZ210_C_TRAVELTP_SOL,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
