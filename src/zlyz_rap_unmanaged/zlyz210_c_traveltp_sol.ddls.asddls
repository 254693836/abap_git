...
define root view entity ZLYZ210_C_TRAVELTP_SOL
  provider contract transactional_query
  as projection on ZLYZ210_R_TRAVELTP_SOL
{
  ...
  key     TravelID,
          ...
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZLYZ210_CALC_TRAV_ELEM_SOL'
  ...
  virtual OverallStatusIndicator : abap.int2,
          ...
          // public associations
          _Booking : redirected to composition child ZLYZ210_C_BOOKINGTP_SOL,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
