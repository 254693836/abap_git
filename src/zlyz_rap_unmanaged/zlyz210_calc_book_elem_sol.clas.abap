CLASS zlyz210_calc_book_elem_sol DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_days_to_flight
        IMPORTING is_original_data TYPE ZLYZ210_C_BookingTP_SOL
        RETURNING VALUE(result)    TYPE ZLYZ210_C_BookingTP_SOL.
...
CLASS zlyz210_calc_book_elem_sol IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      ...
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'INITIALDAYSTOFLIGHT'   OR 'REMAININGDAYSTOFLIGHT'
          ...
          DATA lt_book_original_data TYPE STANDARD TABLE OF ZLYZ210_C_BookingTP_SOL WITH DEFAULT KEY.
          ...
          LOOP AT lt_book_original_data ASSIGNING FIELD-SYMBOL(<fs_book_original_data>).
            <fs_book_original_data> = zlyz210_calc_book_elem_SOL=>calculate_days_to_flight( <fs_book_original_data> ).
          ENDLOOP.
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZLYZ210_C_BOOKINGTP_SOL'. "Booking BO node
